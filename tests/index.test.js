...
describe("Task endpoints", () => {
	...
	// 	//   test("user is not able to add attachment without taskId", async () => {});
...
describe("Chats endpoints", () => {
	...
	// });✅✅✅
		...
		// 		}
		// 	);
		// 	expect(createChatResponse.status).toBe(403);
		// });
	// 	test("user is able to delete chat", async () => {
	// 		const deleteChatResponse = await axios.post(
	...
	// 		expect(deleteChatResponse.status).toBe(403);
	// 	});
	...
	// 			`${BACKEND_URL}/chats/${workspaceId}/${chatId}/messages?${messageId}`,
	// 			{
	// 				headers: {
	// 					Authorization: `Bearer ${adminToken}`,
	// 				},
	...
	// 		expect(deleteChatResponse.status).toBe(200);
	// 	});
	// 	test("user is not able to delete chat message if not created by", async () => {
	// 		const deleteChatResponse = await axios.delete(
	// 			`${BACKEND_URL}/chats/${workspaceId}/${chatId}/messages?${messageId}`,
	// 			{
	// 				headers: {
	...
	// 		const deleteChatResponse = await axios.delete(
	// 			`${BACKEND_URL}/chats/${workspaceId}/${chatId}/${memberId}`,
	// 			{
	// 				headers: {
	// 					Authorization: `Bearer ${adminToken}`,
	// 				},
	...
	// 		expect(deleteChatResponse.status).toBe(403);
	// 	});
	// 	test("user is not able to add member by member", async () => {
	// 		const deleteChatResponse = await axios.delete(
	// 			`${BACKEND_URL}/chats/${workspaceId}/${chatId}/${memberId}`,
	// 			{
	// 				headers: {
