...
exports.deleteMemberFromWorkspace =
	exports.getAllMembersFromWorkspace =
	exports.addMemeberInWorkspace =
...
const workspaceClient = (0, redis_1.createClient)({
...
const isValidUser = (userId) =>
	__awaiter(void 0, void 0, void 0, function* () {
		...
		const collection =
			db === null || db === void 0 ? void 0 : db.collection("User");
		const user = yield collection === null || collection === void 0
			? void 0
			: collection.findOne({
...
const createWorkspaceService = (data) =>
	__awaiter(void 0, void 0, void 0, function* () {
		var _a, _b, _c;
		...
		yield Promise.all(
			(
				((_a = parsedData.data) === null || _a === void 0
					? void 0
					: _a.members) || []
			).map((userId) =>
				__awaiter(void 0, void 0, void 0, function* () {
		...
		try {
			...
			const updatedMember =
				(_c =
					(_b = parsedData.data.members) === null || _b === void 0
						? void 0
						: _b.map((id) => ({
								userId: id,
			...
			const member = yield workspaceMember_model_1.WorkspaceMemberModel.create(
				updatedMember,
				{
					session,
				}
			...
			const updatedWorkspace =
				yield workspace_model_1.WorkspaceModel.findByIdAndUpdate(
					workspace[0]._id,
					{ $set: { member } },
					{ new: true, session }
				);
...
workspaceClient.subscribe("createWorkspace", (message) =>
	__awaiter(void 0, void 0, void 0, function* () {
...
const createWorkspace = (0, asyncHandler_1.asyncHandler)((req, res) =>
	__awaiter(void 0, void 0, void 0, function* () {
		var _a;
		const workspace = yield createWorkspaceService(
			Object.assign(Object.assign({}, req.body), {
				owner:
					(_a = req.member) === null || _a === void 0
						? void 0
						: _a._id.toString(),
			})
		);
...
const deleteWorkspace = (0, asyncHandler_1.asyncHandler)((req, res) =>
	__awaiter(void 0, void 0, void 0, function* () {
		...
		if (workspace.owner.toString() !== req.member._id.toString()) {
			throw new ApiError_1.ApiError(401, "Unauthorized to delete workspace");
		}
		const session = yield mongoose_1.default.startSession();
		session.startTransaction();
		try {
			yield Promise.all([
				attachment_model_1.AttachmentModel.deleteMany(
					{ taskId: { $in: workspace.tasks } },
					{ session: session }
				),
				comment_model_1.CommentModel.deleteMany(
					{ taskId: { $in: workspace.tasks } },
					{ session: session }
				),
				task_model_1.TaskModel.deleteMany(
					{ _id: { $in: workspace.tasks } },
					{ session: session }
				),
				workspaceMember_model_1.WorkspaceMemberModel.deleteMany(
					{ workspace: workspace._id },
					{ session: session }
				),
			]);
			yield workspace_model_1.WorkspaceModel.deleteOne(
				{ _id: workspace._id },
				{ session: session }
			);
			yield session.commitTransaction();
		...
		res
			.status(200)
			.json(new ApiResponse_1.ApiResponse(200, {}, "Deleted successfully"));
	})
);
exports.deleteWorkspace = deleteWorkspace;
const updateWorkspace = (0, asyncHandler_1.asyncHandler)((req, res) =>
	__awaiter(void 0, void 0, void 0, function* () {
		const { workspaceId } = req.params;
		if (!workspaceId) {
			throw new ApiError_1.ApiError(400, "Workspace id required");
		}
		const parsedData = validation_1.updateWorkspaceNameSchema.safeParse(
			req.body
		);
		if (!parsedData.success) {
		...
		if (workspace.owner.toString() !== req.member._id.toString()) {
			throw new ApiError_1.ApiError(401, "Unauthorized to edit workspace name");
		}
		const updatedWorkspace =
			yield workspace_model_1.WorkspaceModel.findByIdAndUpdate(
				workspace._id,
...
const getWorkspace = (0, asyncHandler_1.asyncHandler)((req, res) =>
	__awaiter(void 0, void 0, void 0, function* () {
...
const addMemeberInWorkspace = (0, asyncHandler_1.asyncHandler)((req, res) =>
	__awaiter(void 0, void 0, void 0, function* () {
		const parsedData = validation_1.addMemeberInWorkspaceSchema.safeParse(
			req.body
		);
		if (!parsedData.success) {
		...
		if (
			...
			throw new ApiError_1.ApiError(401, "Unauthorized to add editor");
		}
		const session = yield mongoose_1.default.startSession();
		session.startTransaction();
		try {
			const workspaceMember =
				yield workspaceMember_model_1.WorkspaceMemberModel.create(
					[
						{
...
const getAllMembersFromWorkspace = (0, asyncHandler_1.asyncHandler)(
	(req, res) => __awaiter(void 0, void 0, void 0, function* () {})
);
exports.getAllMembersFromWorkspace = getAllMembersFromWorkspace;
const deleteMemberFromWorkspace = (0, asyncHandler_1.asyncHandler)((req, res) =>
	__awaiter(void 0, void 0, void 0, function* () {
		const { memberId } = req.query;
		if (!memberId) {
			throw new ApiError_1.ApiError(400, "userId is required");
		}
		const member = yield workspaceMember_model_1.WorkspaceMemberModel.findById(
			memberId
		);
		if (!member) {
		...
		if (
			...
			throw new ApiError_1.ApiError(401, "Unauthorized to delete member");
		}
		const session = yield mongoose_1.default.startSession();
		session.startTransaction();
		try {
			...
			const workspaceMember =
				yield workspaceMember_model_1.WorkspaceMemberModel.findByIdAndDelete(
					member._id,
					{ session }
				);
			if (!workspaceMember) {
		...
		res
			.status(200)
			.json(new ApiResponse_1.ApiResponse(200, {}, "Delete successfully"));
	})
);
