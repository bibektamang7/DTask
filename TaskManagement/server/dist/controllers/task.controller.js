...
exports.deleteComment =
	...
	exports.deleteAttachmentFromTask =
	exports.addAttachmentInTask =
	exports.deleteTask =
	exports.updateTask =
	exports.getTask =
	exports.getTasks =
...
const isMemberInWorkspace = (memberId) =>
	__awaiter(void 0, void 0, void 0, function* () {
		const db = mongoose_1.default.connection.db; // Get the database connection
		const collection =
			db === null || db === void 0 ? void 0 : db.collection("workspacemembers"); // Get the collection
		const member = yield collection === null || collection === void 0
			? void 0
			: collection.findOne({
...
const createTask = (0, asyncHandler_1.asyncHandler)((req, res) =>
	__awaiter(void 0, void 0, void 0, function* () {
		...
		const workspaceMembers = yield Promise.all(
			parsedData.data.assignees.map((userId) =>
				__awaiter(void 0, void 0, void 0, function* () {
		...
		res
			.status(200)
			.json(
				new ApiResponse_1.ApiResponse(200, task, "Task created successfully")
			);
	})
);
exports.createTask = createTask;
const getTasks = (0, asyncHandler_1.asyncHandler)((req, res) =>
	__awaiter(void 0, void 0, void 0, function* () {})
);
exports.getTasks = getTasks;
const getTask = (0, asyncHandler_1.asyncHandler)((req, res) =>
	__awaiter(void 0, void 0, void 0, function* () {
...
const updateTask = (0, asyncHandler_1.asyncHandler)((req, res) =>
	__awaiter(void 0, void 0, void 0, function* () {})
);
exports.updateTask = updateTask;
const deleteTask = (0, asyncHandler_1.asyncHandler)((req, res) =>
	__awaiter(void 0, void 0, void 0, function* () {
		...
		if (
			task.workspaceId.toString() !==
				req.workspaceMember.workspace.toString() ||
		...
		try {
			const deletedTask = yield task_model_1.TaskModel.findByIdAndDelete(
				task._id,
				{
					session: session,
				}
			...
			const deleteAttachments =
				yield attachment_model_1.AttachmentModel.deleteMany(
					{
...
const addAttachmentInTask = (0, asyncHandler_1.asyncHandler)((req, res) =>
	__awaiter(void 0, void 0, void 0, function* () {
		const { taskId } = req.params;
		if (!taskId) {
			throw new ApiError_1.ApiError(400, "Task id required");
		...
		try {
			...
			if (files && files.length > 0) {
				attachments = yield Promise.all(
					files.map((file) =>
						__awaiter(void 0, void 0, void 0, function* () {
							const fileUploadResponse = yield (0,
							fileUpload_cloudinary_1.uploadOnCloudinary)(
								file.path,
								`/tasks/${task._id}`
							);
			...
			const updatedTask = yield task_model_1.TaskModel.findByIdAndUpdate(
				task._id,
				{
					$push: {
...
const deleteAttachmentFromTask = (0, asyncHandler_1.asyncHandler)((req, res) =>
	__awaiter(void 0, void 0, void 0, function* () {
		...
		if (
			!task.attachments.includes(
				new mongoose_1.default.Types.ObjectId(attachmentId)
			)
		) {
		...
		try {
			const attachment =
				yield attachment_model_1.AttachmentModel.findByIdAndDelete(
					attachmentId,
					{
						session,
					}
		...
		res
			.status(200)
			.json(new ApiResponse_1.ApiResponse(200, {}, "Attachment deleted"));
	})
);
exports.deleteAttachmentFromTask = deleteAttachmentFromTask;
// comments handlers
const createComment = (0, asyncHandler_1.asyncHandler)((req, res) =>
	__awaiter(void 0, void 0, void 0, function* () {
		...
		// TODO:EXTRACT USERID FROM ASSIGNEES
		const task = yield task_model_1.TaskModel.findById(
		...
		try {
			...
			if (req.file) {
				...
				attachment = yield attachment_model_1.AttachmentModel.create(
					[
						{
							filename:
								fileUploadResponse === null || fileUploadResponse === void 0
									? void 0
									: fileUploadResponse.filename,
							fileType:
								fileUploadResponse === null || fileUploadResponse === void 0
									? void 0
									: fileUploadResponse.format,
							fileUrl:
								fileUploadResponse === null || fileUploadResponse === void 0
									? void 0
									: fileUploadResponse.url,
			...
			const comment = yield comment_model_1.CommentModel.create(
				...
				// @ts-ignore
				[
					Object.assign(Object.assign({}, parsedData.data), {
						attachments:
							(attachment === null || attachment === void 0
								? void 0
								: attachment._id) || undefined,
					}),
				],
				{
					session: session,
...
const deleteComment = (0, asyncHandler_1.asyncHandler)((req, res) =>
	__awaiter(void 0, void 0, void 0, function* () {
		...
		try {
			...
			const deletedComment =
				yield comment_model_1.CommentModel.findByIdAndDelete(comment._id, {
					session: session,
				});
			if (!deletedComment) {
			...
			res
				.status(200)
				.json(
					new ApiResponse_1.ApiResponse(200, {}, "Comment Deleted successfully")
				);
		} catch (error) {
			yield session.abortTransaction();
			throw new ApiError_1.ApiError(
