			...
			<div className="lg:w-[50%] w-full h-full flex flex-col items-center justify-between">
						...
						<div className="flex items-center justify-between">
							<div className="flex items-center space-x-2">
								...
								<label
									...
									I agree to the <Link className="underline text-indigo-500" to={`/terms`}>Terms & conditions</Link>
								</label>
							</div>
						</div>
						<Button className="w-full mt-12 py-5">Create account</Button>
					</form>
					<div>
				...
				<div className="flex">
					<p className="text-sm text-gray-500">Already have an account?
						<Link className="text-white font-normal" to={`/login`}> Login</Link>
					</p>
				</div>
			</div>
		</section>
